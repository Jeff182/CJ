      ...
      CHARACTER*10 IPNAME(60)
      character*4 fnot,froz,blnk,tol,err
      REAL*8 MODALF 
      DIMENSION ALPHA(40,40),MODALF(40,40),BETA(40),COV(40,40) 
      DIMENSION OLDPAR(60),DATA(1,1)
      COMMON/ERRORS/COV
...
C EVALUATE ERRORS AND PRINT OUT RESULTS OF FIT 
 ...
 1305 FORMAT(1H0,17HTHE TOLERANCE IS ,F9.4/32H THE MAXIMUM NUMBER OF STE 
     1PS IS ,I3) 
 ...
 1360 FORMAT(12H0 THERE WERE,I3,40H DATA POINTS WITH ZERO OR NEGATIVE ER 
     1ROR)
 ...
 1380 FORMAT(1X,20F7.3) 
      ...
      implicit real*8 (a-h,o-z)
      character*10 ititle(30)
      dimension errn(30),iserr(30),itype(30),nflag(30),inorm(30),
     2itgt(30),icorr(30)
      DIMENSION ALPHA(40,40),BETA(40) 
      COMMON/MINIMB/CURPAR(60),UNCRT(60),ERMIN(40),PWATE(60),IFREP(40), 
     1NPARAM,NVAR,IREJ 
      COMMON/AMAT/ALPHA,BETA
      ...
      DIMENSION DATA(NX,NNPTS),V(10),DRV(60),cdfxsec(100),
     2cdfdrv(60,100)
      save cdfxsec
      NN=NX-2 
C CALCULATE CHI SQUARE
...
c
      chisqr0 =chisqr
*****  NEW CALL TO INDEPENDENT ROUTINE in 'chi2.f'
      if(ncov.ne.0)then
...
c
      do 11 i=1,nfit
      if(errn(i).eq.0.d0.or.inorm(i).eq.60)goto 11
...
c
      do 12 i=1,nvar
      do 13 k=1,nfit
      if(errn(k).eq.0.d0.or.inorm(k).eq.60)goto 13
 ...
 12   continue
      ...
      implicit real*8 (a-h,o-z)
      DIMENSION ARRAY(40,40),IK(40),JK(40)
C
