...
*     (12 Nov 08)  modifeid the d-quark parametrization to             *
...
************************************************************************
      ...
      DIMENSION FVL(50),FVL1(50),FVLSTO(50),PRD(50),PRD1(50),
     $ COR(50),COR1(50),FUDGE(50),PRDM(50)
      DIMENSION FS(50),FS1(50),FSSTO(50),PRDS(50),PRDS1(50),CORS(50), 
     $ CORS1(50),FUDGES(50),PRDMS(50)
      DIMENSION FG(50),FG1(50),FGSTO(50),PRDG(50),PRDG1(50),CORG(50), 
     $ CORG1(50),FUDGEG(50),PRDMG(50)
      DIMENSION XPAR(60)
...
*     (A.Accardi 2-9 Jul 2009) 
*     NOTE: runs prior to Jul 9 had a bug: xp(32) was multiplied by 0.5 
      fdv=xp(8)*x**xp(9)*(1.-x)**xp(10)*exp(xp(11)*x)
     &     *(1.+exp(xp(12))*x)**xp(13)
     &     + dabs(xp(32))*(x**dabs(xp(33)))*fuv(x)

c --------------------------------------------------
* (30 Jun 09) d-valence for d/u->finite as x->1. 
*     Functional form from Bodek-Yang, PRL82(99)2467
*     with free parameter to allow any  lim_(x->1) d/u. 
*     (A.Accardi 30 Jun 2009)
c$$$      fdv=xp(8)*x**xp(9)*(1.-x)**xp(10)*exp(xp(11)*x)
c$$$     &     *(1.+exp(xp(12))*x)**xp(13)
c$$$     &     + 0.5*dabs(xp(32))*x*(1+x)*fuv(x)

c --------------------------------------------------
* (12 Nov 08) d-valence for d/u->finite as x->1. 
*     Tried inside cteqX fits, doesn't seem sensitive enough.
...
* superseded by the large-x parametrization Jul'09 that allows 
* d/u->finite as x->1.  
*
*      fdv=xp(8)*x**xp(9)*(1.-x)**xp(10)*exp(xp(11)*x)*
*     $(1.+exp(xp(12))*x)**xp(13)
...
C  AS NEEDED FOR THE PREDICTOR-CORRECTOR ALGORITHM
      DIMENSION FVLSTO(50),FVL(50),FVL1(50),TVLSTO(50)
      COMMON/GRID/NX,XGRID(50)
      DO 1 I=1,NX
...
C  FOR THE PREDICTOR-CORRECTOR ALGORITHM
      DIMENSION FS(50),FS1(50),FSSTO(50),TSSTO(50),
     $          FG(50),FG1(50),FGSTO(50),TGSTO(50)
      COMMON/GRID/NX,XGRID(50)
      DO 1 I=1,NX
