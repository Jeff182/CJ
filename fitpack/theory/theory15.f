...
C
      ...
      if(ioff_flag.ge.5.and.ioff_flag.le.7)then
         call init_offshell ! initializes the offshell mods for PDFs 
                            ...
                            ! need recalculation every time PDFs change;
...
c
         ...
         call init_offshell_KP(xc) !Applies valence quark constraint for 
                                   ! the KP model
         x1(ndrv)=x_1
         print*,ndrv,x1(ndrv),x_1
      endif 
...
c
      ...
      if (ism.le.1) then           ! no smearing, no offshell
         ...
         DO I=1,NTERMS
            ...
            if (ioff.ge.5) then                          ! fmKP off-shell model
     ...
     &                     sbop,cbop,bbop,glueop)
            ...
            if (xoy.lt.0.995d0) then
               ...
               if (ioff.ge.5) then !fmKP offshell correction
