     ...
     2yg(18), yj(18)
      akfac1(x)=1.7052-.0025083*x+4.4876e-6*x**2-1.2827e-9*x**3
      akfac2(x)=1.8628-.0044022*x+1.1747e-5*x**2-1.1336e-8*x**3
      akfac3(x)=2.3962-.0130730*x+6.5069e-5*x**2+4.8698e-8*x**3
      akfac4(x)=3.5016-.0330140*x+1.9910e-4*x**2-3.7492e-7*x**3
...
c      endif
 ...
 200  continue
      ...
      idum=1
      dum=0.d0
      call pdf(ndrv,xa,als,u,d,ub,db,sb,cb,bb,glue)
      qa(-5)=bb/xa
      qa(-4)=cb/xa
      qa(-3)=sb/xa
      qa(-2)=db/xa
...
c 
      call pdf(ndrv,xb,als,u,d,ub,db,sb,cb,bb,glue)
      qb(-5)=bb/xb
      qb(-4)=cb/xb
      qb(-3)=sb/xb
      qb(-2)=d/xb
