     ...
     2,VP(4),FTEMP(2),NFLAG(35),INORM(35),itype(35),ITGT(35),icorr(35)
     3,itmc(35),iht(35), tv(4),tmp(1008), sumd0(36)
...
c  Move calcualtion from ALTPAR to here
c
...
* it=80 is electron neutral current
* it=81 is positron neutral current
         az = 1.                ! proton target
         an = 0.
         x=vp(1)
         Q2=vp(2)
...
c               theory=theory*(0.776+0.011*v(3))/xc(in)  
     ...
     2                +0.014762*V(3)**2)/xc(in)  
         ...
         ELSE IF(IT.GE.126.and.IT.LE.131.or.it.eq.153)THEN
            S=V(1)
            Y=V(3)
            RS=SQRT(S)
            ALS=DLOG(DLOG(80.**2/XC(1)**2)/dlog(q02/xc(1)**2))
...
c
     ...
     >- 0.001236 * x**3 - 0.0019652 * x**4 + 0.00041654 * x**5
      ATLASp = 1.1073 + 0.0039 * x
      ATLASm = 1.1030 + 0.0043 * x
c  cteq2m flag
      ist=1
