...
Note that in all the previous studies the off-shell corrections
were applied only to the deuteron $F_2^d$ structure function
and in the valence quark approximation.
