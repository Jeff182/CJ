...
understood, at least in the sense that they can be directly related
to the properties of the deuteron wave function, the nucleon off-shell
correction $q^{d\, (\rm off)}$ in Eq.~(\ref{eq:qdoff}) is much more
model dependent.
In the literature a number of model studies have been performed to
estimate the modification of PDFs in bound nucleons relative to the
free nucleon PDFs \cite{GL92, MSToff, KPW94, MSTplb, KMPW95, MSS97,
KP06, Mineo04, Cloet06}, some of which have been motivated by the
original observation of the nuclear EMC effect.
...
- in some studies covariant spectator quark models, with scalar
or axial vector spectator diquarks, have been modeled 
\cite{MSToff, KPW94, MSTplb, KMPW95}
...
MST (theoretical)
