...
%
Uncertainties in other modern PDF analyses, such as CT14, ABM, ... ...
are generally between the representative sets illustrated in
Fig.~\ref{fig:ratio}.
%
...
(``$qq$'' for valence quarks, ``$qq\bar q$'' for sea quarks,
...
at $p^2=M^2$ is then included as a parameter in the fit, with
errors propagated along with those of the other fit parameters
...
... off-shell corrections alone are unphyiscal, in the sense that
only the combination of deuteron wave function (in the smearing
function) and off-shell correction affects the observable $F_2^d$
structure function ...
... this is clearly illustrated in Fig.~\ref{fig:F2dN}, where
... maybe F2d/F2N plots discussed here??? ... give almost
identical ratios???



... as observed in our earlier study \cite{CJ10}, there is some degree 
of compensation/interplay ... between the TMCs and higher twist 
corrections ...
The parameters for the higher twist correction to $F_2$ in
Eqs.~(\ref{eq:F2ht}) and (\ref{eq:C_ht})
