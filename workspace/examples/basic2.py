...
gs.update(left=0.1, right=0.99, wspace=0.3,hspace=0.1,top=0.98,bottom=0.1)
...
for flav in ['u','d','ub','db','s','g']:
  ...
  for grp in ['CJ15','HERA15','MMHT14','MSTW08']:
    ...
    if flav=='g': ax.legend(loc=1,frameon=0,fontsize=15)
    if flav=='u': ax.text(0.1,0.1,'$Q^2=$'+tex('10GeV^2~LO'),\
